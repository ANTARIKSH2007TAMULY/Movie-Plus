  ...
  return (
    <div className="min-h-screen">
      <div className="mx-auto w-full max-w-[2000px] px-4 py-8 sm:px-6">
        ...
        <div className="mb-8 grid grid-cols-1 gap-3 rounded-2xl border border-slate-200 bg-white p-4 shadow-soft dark:border-slate-800 dark:bg-slate-950 sm:grid-cols-2 lg:grid-cols-4">
